...
public class BalanceGameController {
	...
	public ResponseEntity<List<BalanceGameDTO>> selectBalanceGameList(@RequestBody Map<String, String> request, Model model) {
	...
	public List<BalanceGameCommentDTO> updateBalanceGameCommentLikeCount(@RequestBody Map<String, String> request) {
		...
		try {
			List<BalanceGameCommentDTO> balanceGameCommenList = balanceGameService.updateBalanceGameCommentLikeCount(request);
	...
	@ResponseBody
	public Map<String, Object> insertBalanceGame(@RequestParam Map<String, String> params, @RequestParam MultipartFile option1Image, @RequestParam MultipartFile option2Image) {
